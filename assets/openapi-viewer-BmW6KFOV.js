...
`}}},Me='ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace',_={fontFamily:Me,fontSize:"0.85rem"},ue=r=>{switch(r){case"GET":return"success";case"POST":return"primary";case"PUT":case"PATCH":return"warning";case"DELETE":return"error";default:return"default"}},ie={border:"1px solid",borderColor:"divider",borderRadius:1.5,bgcolor:"background.paper"},Q=(r,h=0)=>{if(!r||h>4)return"...";if(r.$ref&&typeof r.$ref=="string")return`{${r.$ref.split("/").pop()??r.$ref}}`;const f=r?.type;return f==="array"||r?.items?`[${Q(r?.items??{},h+1)}]`:f==="object"||r?.properties?`{ ${(r?.properties?Object.entries(r.properties):[]).map(([w,k])=>`${w}: ${Q(k,h+1)}`).join(", ")} }`:r?.enum?.length?r.enum.map(m=>String(m)).join(" | "):f??"object"},ce=r=>{if(!r)return"";try{return JSON.stringify(JSON.parse(r),null,2)}catch{const h=r.trim();let f="",m=0;const E=()=>"  ".repeat(Math.max(m,0));for(let w=0;w<h.length;w+=1){const k=h[w];k==="{"||k==="["?(f+=k+`
`,m+=1,f+=E()):k==="}"||k==="]"?(m-=1,f+=`
`+E()+k):k===","?f+=k+`
`+E():f+=k}return f}},Fe=()=>{const{spec:r,info:h,servers:f,operations:m,tags:E,schemas:w,loading:k,error:R,fileName:B,handleFile:oe,handleReset:A,buildExportHtml:Z}=De(),D=j.useRef(null),[M,F]=j.useState(null),[ne,z]=j.useState("paths"),[$,y]=j.useState(""),W=j.useRef(null),L=j.useRef(null),[C,K]=j.useState(.4),[N,J]=j.useState(.38),[G,I]=j.useState({}),[P,U]=j.useState(null),te=j.useMemo(()=>{const t=w.find(a=>a.name===P)?.shapeText??"";return ce(t)},[w,P]),s=()=>D.current?.click(),n=()=>{if(r)try{const t=Z();if(!t)return;const a=new Blob([t],{type:"text/html;charset=utf-8"}),u=URL.createObjectURL(a),l=B?.replace(/\.json$/i,"")||h.title||"openapi-doc",g=document.createElement("a");g.href=u,g.download=`${l}.html`,document.body.appendChild(g),g.click(),document.body.removeChild(g),URL.revokeObjectURL(u)}catch(t){console.error(t),alert("HTML 다운로드 중 오류가 발생했습니다.")}},o=j.useMemo(()=>{const t=[...E],a=new Map;m.forEach(g=>{const q=g.primaryTag||"default";a.has(q)||a.set(q,[]),a.get(q).push(g)});const u=Array.from(a.keys()).filter(g=>!t.includes(g));return[...t,...u].map(g=>({tag:g,ops:a.get(g)??[]})).filter(g=>g.ops.length>0)},[m,E]),i=j.useMemo(()=>{const t=o.flatMap(u=>u.ops),a=t[0]||null;return M?t.find(u=>`${u.method}-${u.path}`===M)??a:a},[M,o]),x=j.useMemo(()=>{if(!i)return"";const t=i.parameters?.filter(a=>a.in==="path")??[];return i.path.replace(/\{([^}]+)\}/g,(a,u)=>{const l=t.find(q=>q.name===u);if(!l)return`{${u}}`;const g=l.example!==void 0?typeof l.example=="string"?l.example:JSON.stringify(l.example):"<value>";return String(g)})},[i]);j.useEffect(()=>{f?.length&&!$&&y(f[0]?.url??"")},[f,$]),j.useEffect(()=>{const t={};o.forEach(a=>{t[a.tag]=!1}),I(t)},[o]),j.useEffect(()=>{if(!w.length){U(null);return}(!P||!w.find(t=>t.name===P))&&U(w[0].name)},[w,P]);const b=j.useMemo(()=>w.find(t=>t.name===P)??w[0]??null,[w,P]),T=(t,a)=>u=>{u.preventDefault();const l=t.current;if(!l)return;const g=l.getBoundingClientRect(),q=X=>{const fe=(X-g.left)/g.width,ge=Math.min(.75,Math.max(.25,fe));a(ge)},pe=X=>q(X.clientX),he=X=>{X.preventDefault(),q(X.touches[0]?.clientX??0)},V=()=>{window.removeEventListener("mousemove",pe),window.removeEventListener("touchmove",he),window.removeEventListener("mouseup",V),window.removeEventListener("touchend",V),window.removeEventListener("touchcancel",V)};window.addEventListener("mousemove",pe),window.addEventListener("touchmove",he,{passive:!1}),window.addEventListener("mouseup",V),window.addEventListener("touchend",V),window.addEventListener("touchcancel",V)},H=T(W,K),re=T(L,J);return e.jsxs(be,{sx:{p:1.25,display:"flex",flexDirection:"column",gap:1.25,flex:1,minHeight:785,height:"100%",width:1,maxWidth:"100%",overflowX:"hidden"},children:[e.jsxs(p,{sx:{...ie,p:1.25,display:"flex",gap:1,alignItems:"center",flexWrap:"wrap",justifyContent:"space-between"},children:[e.jsxs(v,{direction:"row",spacing:1,alignItems:"center",flexWrap:"wrap",children:[e.jsx(ve,{title:"Swagger에서 제공하는 api-docs.json 파일을 업로드하세요.",children:e.jsx(ye,{size:"small","aria-label":"api-docs.json 설명",children:e.jsx(je,{fontSize:"small"})})}),e.jsx(se,{size:"small",variant:"contained",startIcon:e.jsx(we,{}),onClick:s,children:"api-docs.json 업로드"}),e.jsx("input",{type:"file",accept:"application/json,.json",style:{display:"none"},ref:D,onChange:t=>{const a=t.target.files?.[0];a&&oe(a)}}),e.jsx(se,{size:"small",variant:"outlined",color:"primary",startIcon:e.jsx($e,{}),onClick:A,disabled:!r&&!B,children:"초기화"}),B&&e.jsx(S,{size:"small",icon:e.jsx(me,{fontSize:"small"}),label:B,sx:{maxWidth:"100%"}})]}),e.jsxs(v,{direction:"row",spacing:1,alignItems:"center",flexWrap:"wrap",children:[e.jsx(se,{size:"small",variant:"outlined",color:"primary",startIcon:e.jsx(Se,{}),component:"a",href:"/sample/api-docs.json",download:!0,children:"샘플 다운로드"}),e.jsx(se,{size:"small",variant:"outlined",color:"primary",startIcon:e.jsx(ke,{}),onClick:n,disabled:!r,children:"HTML 다운로드"})]})]}),k&&e.jsx(Te,{}),R&&e.jsx(ze,{severity:"error",children:R}),!r&&!k&&!R&&e.jsxs(p,{sx:{...ie,p:1.25,display:"flex",flexDirection:"column",gap:1,alignItems:"center",justifyContent:"center",color:"text.secondary",textAlign:"center",flex:1,minHeight:240},children:[e.jsx(d,{variant:"body1",fontWeight:600,children:"api-docs.json을 업로드하세요"}),e.jsx(d,{variant:"body2",children:"OpenAPI 3.x JSON 파일을 지원합니다."})]}),r&&e.jsxs(v,{spacing:1.25,sx:{minHeight:695,overflow:"auto",pr:.5,height:"calc(100dvh - 260px)"},children:[e.jsxs(p,{sx:{...ie,p:1.25,display:"flex",flexDirection:"column",gap:1.25},children:[e.jsxs(v,{direction:"row",alignItems:"center",spacing:1,children:[e.jsx(me,{color:"primary"}),e.jsx(d,{variant:"subtitle1",fontWeight:700,children:h.title||"Untitled API"}),h.version&&e.jsx(S,{size:"small",label:`v${h.version}`,variant:"outlined",sx:{ml:1}})]}),h.description&&e.jsx(d,{variant:"body2",color:"text.secondary",sx:{whiteSpace:"pre-line"},children:h.description})]}),e.jsxs(p,{sx:{...ie,p:0,display:"flex",flexDirection:"column",minHeight:0},children:[e.jsxs(Ee,{value:ne,onChange:(t,a)=>z(a),children:[e.jsx(xe,{value:"paths",label:"Paths"}),e.jsx(xe,{value:"schemas",label:"Schemas"})]}),e.jsx(de,{}),ne==="schemas"?e.jsxs(p,{sx:{p:1.25,display:"flex",flexDirection:"column",minHeight:0,flex:1},children:[e.jsxs(v,{direction:"row",alignItems:"center",spacing:1,mb:1,children:[e.jsx(Ce,{color:"primary"}),e.jsxs(d,{variant:"subtitle1",fontWeight:700,children:["Schemas (",w.length,")"]})]}),e.jsx(de,{}),e.jsxs(p,{sx:{display:"flex",flexDirection:"row",gap:1,mt:1,minHeight:0,flex:1},ref:L,children:[e.jsx(p,{sx:{minWidth:{md:320},maxWidth:{md:480},width:{md:`${N*100}%`},overflow:"auto",flexShrink:0,borderColor:"divider",pr:{md:1},pb:{xs:1,md:0}},children:e.jsxs(v,{spacing:.75,sx:{mt:1},children:[w.length===0&&e.jsx(d,{variant:"body2",color:"text.secondary",children:"스키마가 없습니다."}),w.map(t=>{const a=b?.name===t.name;return e.jsxs(p,{sx:{border:"1px solid",borderColor:a?"primary.main":"divider",borderRadius:1,p:1,bgcolor:a?"action.selected":"background.default",cursor:"pointer","&:hover":{borderColor:"primary.main"}},onClick:()=>U(t.name),children:[e.jsxs(v,{direction:"row",spacing:.75,alignItems:"center",flexWrap:"wrap",children:[e.jsx(d,{variant:"subtitle2",fontWeight:700,sx:{wordBreak:"break-word"},children:t.name}),t.type&&e.jsx(S,{size:"small",label:t.type,variant:"outlined"}),t.properties?.length?e.jsx(S,{size:"small",variant:"outlined",label:`${t.properties.length} props`}):null]}),t.description&&e.jsx(d,{variant:"body2",color:"text.secondary",sx:{mt:.25},children:t.description})]},t.name)})]})}),e.jsx(p,{onMouseDown:re,onTouchStart:re,sx:{width:6,flexShrink:0,cursor:"col-resize",bgcolor:"divider",borderRadius:999,alignSelf:"stretch",display:{xs:"none",md:"block"}}}),e.jsxs(p,{sx:{flex:1,overflow:"auto",pl:{md:1},minWidth:0,minHeight:0,wordBreak:"break-word",overflowWrap:"anywhere"},children:[!b&&e.jsx(d,{variant:"body2",color:"text.secondary",sx:{mt:1},children:"스키마를 선택하세요."}),b&&e.jsxs(v,{spacing:1,sx:{mt:1},children:[e.jsxs(v,{direction:"row",spacing:1,alignItems:"flex-start",flexWrap:"wrap",children:[e.jsxs(v,{direction:"column",spacing:0,children:[e.jsx(d,{variant:"h6",fontWeight:800,children:b.name}),b.description&&e.jsx(d,{variant:"body2",color:"text.secondary",sx:{mt:-.5},children:b.description})]}),e.jsxs(v,{direction:"row",spacing:1,alignItems:"center",flexWrap:"wrap",sx:{ml:1},children:[b.type&&e.jsx(S,{size:"small",label:b.type,variant:"outlined"}),b.properties?.length?e.jsx(S,{size:"small",variant:"outlined",label:`${b.properties.length} properties`}):null]})]}),b.shapeText&&e.jsxs(p,{sx:{border:"1px dashed",borderColor:"divider",borderRadius:1,p:1,bgcolor:"background.default"},children:[e.jsx(d,{variant:"caption",color:"text.secondary",children:"Schema"}),e.jsx(p,{component:"pre",sx:{m:0,mt:.25,..._,whiteSpace:"pre-wrap",wordBreak:"break-word"},children:te})]}),b.propertiesDetail&&b.propertiesDetail.length>0&&e.jsxs(p,{sx:{border:"1px solid",borderColor:"divider",borderRadius:1,p:1,bgcolor:"background.default"},children:[e.jsx(d,{variant:"subtitle2",fontWeight:700,gutterBottom:!0,children:"Properties"}),e.jsxs(p,{component:"table",sx:{width:"100%",tableLayout:"fixed",borderCollapse:"collapse","& th, & td":{borderBottom:"1px solid",borderColor:"divider",textAlign:"left",padding:"6px 8px",verticalAlign:"top"},"& th":{color:"text.secondary",fontWeight:700,fontSize:"0.8rem"},"& td":{fontSize:"0.9rem"}},children:[e.jsxs("colgroup",{children:[e.jsx("col",{width:"25%"}),e.jsx("col",{width:"25%"}),e.jsx("col",{width:"100px"}),e.jsx("col",{})]}),e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Key"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"Required"}),e.jsx("th",{children:"Description"})]})}),e.jsx("tbody",{children:b.propertiesDetail.map(t=>e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(d,{fontSize:"small",color:"primary",children:t.name})}),e.jsx("td",{children:t.typeText?e.jsx(S,{size:"small",label:t.typeText,variant:"outlined"}):"-"}),e.jsx("td",{children:t.required?e.jsx(S,{size:"small",color:"error",label:"required"}):e.jsx(d,{variant:"body2",color:"text.secondary",children:"optional"})}),e.jsx("td",{children:t.description?e.jsx(d,{variant:"body2",color:"text.secondary",children:t.description}):e.jsx(d,{variant:"body2",color:"text.secondary",children:"-"})})]},t.name))})]})]}),!b.propertiesDetail?.length&&e.jsx(d,{variant:"body2",color:"text.secondary",children:"프로퍼티 정보가 없습니다."})]})]})]})]}):e.jsxs(p,{sx:{p:1.25,display:"flex",flexDirection:"column",minHeight:0,flex:1},children:[e.jsxs(p,{sx:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:1,flexWrap:"wrap"},children:[e.jsxs(d,{variant:"subtitle1",fontWeight:700,children:["Paths (",o.reduce((t,a)=>t+a.ops.length,0)," apis)"]}),f.length>0&&e.jsxs(Pe,{size:"small",sx:{minWidth:200},children:[e.jsx(Le,{id:"server-select-label",children:"Server"}),e.jsx(qe,{labelId:"server-select-label",label:"Server",value:$,onChange:t=>y(t.target.value),children:f.map((t,a)=>e.jsxs(Oe,{value:t.url??"",children:[t.url??"N/A",t.description?` · ${t.description}`:""]},`${t.url??a}-${a}`))})]})]}),e.jsx(de,{sx:{mt:1}}),e.jsxs(p,{ref:W,sx:{display:"flex",flexDirection:"row",gap:1,mt:1,minHeight:0,flex:1},children:[e.jsx(p,{sx:{borderBottom:{xs:"1px solid",md:"none"},borderColor:"divider",pr:{md:1},pb:{xs:1,md:0},minWidth:{md:360},maxWidth:{md:620},width:{md:`${C*100}%`},overflow:"auto",flexShrink:0},children:e.jsxs(v,{spacing:1,sx:{mt:1},children:[o.length===0&&e.jsx(d,{variant:"body2",color:"text.secondary",children:"경로가 없습니다."}),o.map(t=>e.jsxs(Re,{disableGutters:!0,expanded:G[t.tag]??!1,onChange:(a,u)=>I(l=>({...l,[t.tag]:u})),children:[e.jsx(Ae,{expandIcon:e.jsx(We,{}),children:e.jsxs(v,{direction:"row",spacing:1,alignItems:"center",flexWrap:"wrap",children:[e.jsx(d,{variant:"subtitle2",fontWeight:700,children:t.tag}),e.jsx(S,{size:"small",variant:"outlined",label:`${t.ops.length} paths`})]})}),e.jsx(Ie,{sx:{pt:0},children:e.jsx(v,{spacing:.75,children:t.ops.map(a=>{const u=`${a.method}-${a.path}`,l=i?.method===a.method&&i?.path===a.path;return e.jsx(p,{sx:{border:"1px solid",borderColor:l?"primary.main":"divider",borderRadius:1,p:1,bgcolor:l?"action.selected":"background.default",cursor:"pointer","&:hover":{borderColor:"primary.main"}},onClick:()=>F(u),children:e.jsxs(v,{spacing:.25,children:[e.jsxs(v,{direction:"row",spacing:1,alignItems:"center",flexWrap:"wrap",children:[e.jsx(S,{size:"small",color:ue(a.method),label:a.method}),e.jsx(d,{variant:"subtitle2",fontWeight:700,noWrap:!0,children:a.path})]}),a.summary&&e.jsxs(d,{variant:"body2",color:"text.primary",sx:{mt:.25},noWrap:!0,children:["Summary: ",a.summary]}),a.description&&e.jsxs(d,{variant:"caption",color:"text.secondary",sx:{display:"-webkit-box",WebkitLineClamp:2,WebkitBoxOrient:"vertical",overflow:"hidden"},children:["Description: ",a.description]})]})},u)})})})]},t.tag))]})}),e.jsx(p,{onMouseDown:H,onTouchStart:H,sx:{width:6,flexShrink:0,cursor:"col-resize",bgcolor:"divider",borderRadius:999,alignSelf:"stretch",display:{xs:"none",md:"block"}}}),e.jsx(p,{sx:{flex:1,minWidth:0,overflow:"auto",p:{md:1},wordBreak:"break-word",overflowWrap:"anywhere"},children:i?e.jsxs(v,{spacing:1.25,children:[e.jsxs(v,{spacing:.5,alignItems:"flex-start",children:[e.jsxs(v,{direction:"row",spacing:1,alignItems:"center",flexWrap:"wrap",children:[e.jsx(S,{size:"small",color:ue(i.method),label:i.method}),e.jsx(d,{variant:"h6",fontWeight:800,sx:{display:"flex",flexWrap:"wrap",gap:.5},children:i.path.split(/(\{[^}]+\})/g).map((t,a)=>t.match(/^\{.*\}$/)?e.jsx(p,{component:"span",sx:{color:"primary.main",fontWeight:700,px:.2,borderRadius:.5,bgcolor:"primary.50"},children:t},a):e.jsx(p,{component:"span",children:t},a))}),i.tags?.[0]&&e.jsx(S,{size:"small",variant:"outlined",label:i.tags[0]})]}),i.summary&&e.jsx(d,{variant:"subtitle1",fontWeight:700,children:i.summary}),i.parameters?.some(t=>t.in==="path")&&x&&e.jsxs(p,{sx:{border:"1px dashed",borderColor:"divider",borderRadius:1,px:1,py:.75,bgcolor:"background.default"},children:[e.jsx(d,{variant:"caption",color:"text.secondary",children:"Path with values"}),e.jsx(d,{variant:"body2",sx:{fontFamily:"monospace",wordBreak:"break-all"},children:x})]})]}),i.description&&e.jsx(d,{variant:"body2",color:"text.secondary",sx:{whiteSpace:"pre-line"},children:i.description}),i.parameters&&i.parameters.length>0&&e.jsxs(p,{sx:{border:"1px solid",borderColor:"divider",borderRadius:1,p:1.25},children:[e.jsx(d,{variant:"subtitle2",fontWeight:700,gutterBottom:!0,children:"Parameters"}),e.jsx(v,{spacing:1,children:[{key:"path",label:"Path parameters"},{key:"query",label:"Query parameters"},{key:"header",label:"Header parameters"},{key:"cookie",label:"Cookie parameters"},{key:"other",label:"Other parameters"}].map(t=>{const a=i.parameters??[],u=t.key==="other"?a.filter(l=>!["path","query","header","cookie"].includes(l.in)):a.filter(l=>l.in===t.key);return u.length?e.jsxs(p,{children:[e.jsx(d,{variant:"subtitle2",fontWeight:700,gutterBottom:!0,children:t.label}),e.jsx(v,{spacing:1,children:e.jsxs(p,{component:"table",sx:{width:"100%",borderCollapse:"collapse","& th, & td":{borderBottom:"1px solid",borderColor:"divider",textAlign:"left",padding:"6px 8px",verticalAlign:"top"},"& th":{color:"text.secondary",fontWeight:700,fontSize:"0.8rem"},"& td":{fontSize:"0.9rem"}},children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Key"}),e.jsx("th",{children:"Type"}),e.jsx("th",{children:"In"}),e.jsx("th",{children:"Required"}),e.jsx("th",{children:"Description"}),e.jsx("th",{children:"Example"})]})}),e.jsx("tbody",{children:u.map(l=>{const g=l.example!==void 0?typeof l.example=="string"?l.example:JSON.stringify(l.example):"<value>",q=l.in==="header"?`${l.name}: ${g}`:l.in==="query"?`${l.name}=${g}`:l.in==="path"?`{${l.name}}: ${g}`:`${l.name}=${g}`;return e.jsxs("tr",{children:[e.jsx("td",{children:e.jsx(d,{variant:"body2",color:"primary",children:l.name})}),e.jsx("td",{children:l.schema?.type??"-"}),e.jsx("td",{children:l.in}),e.jsx("td",{children:l.required?e.jsx(S,{size:"small",color:"error",label:"required"}):e.jsx(d,{variant:"body2",color:"text.secondary",children:"optional"})}),e.jsx("td",{children:l.description?e.jsx(d,{variant:"body2",color:"text.secondary",children:l.description}):e.jsx(d,{variant:"body2",color:"text.secondary",children:"-"})}),e.jsx("td",{children:e.jsx(p,{component:"pre",sx:{m:0,px:1,py:.5,bgcolor:"background.default",borderRadius:1,overflow:"auto",..._,whiteSpace:"pre-wrap",wordBreak:"break-word"},children:q})})]},`${l.in}-${l.name}`)})}),e.jsx("style",{children:`
                                          table {
                                            table-layout: fixed;
                                          }
                                          th,
