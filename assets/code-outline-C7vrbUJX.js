...
app:
  ...
  features:
    - tree-sitter
    - fallback
`},Vt=()=>{const[t,l]=j.useState("java"),[s,e]=j.useState(""),[r,a]=j.useState([]),[n,i]=j.useState(null),[u,d]=j.useState([]),[p,h]=j.useState(!1),[g,_]=j.useState(null),w=j.useRef(null),z=j.useMemo(()=>r.length,[r]),A=j.useCallback(async Z=>{const V=(Z??s).trim();if(!V){a([]),d(["코드를 입력하거나 파일을 업로드해 주세요."]),i(null);return}h(!0),_(null);try{const f=await Ft(V,t);a(f.nodes),d(f.diagnostics),i(f.engine)}catch(f){_(f?.message??String(f)),a([]),i(null),h(!1);return}h(!1)},[t,s]),P=j.useCallback(async Z=>{if(!Z)return;const V=await Z.text();e(V),A(V),w.current&&(w.current.value="")},[A]),O=j.useCallback(()=>{const Z=Ht[t];e(Z),a([]),d([]),i(null),_(null),A(Z)},[A,t]),Y=j.useCallback(Z=>{l(Z),e(""),a([]),d([]),i(null),_(null),w.current&&(w.current.value="")},[]);return{languageId:t,changeLanguage:Y,source:s,setSource:e,outline:r,outlineCount:z,engine:n,diagnostics:u,loading:p,error:g,handleAnalyze:A,handleFileSelect:P,handleSampleLoad:O,fileInputRef:w,languageOptions:Kt}},Xt={file:c.jsx(dt,{fontSize:"inherit"}),class:c.jsx(ot,{fontSize:"inherit"}),interface:c.jsx(ct,{fontSize:"inherit"}),enum:c.jsx(lt,{fontSize:"inherit"}),method:c.jsx(at,{fontSize:"inherit"}),function:c.jsx(rt,{fontSize:"inherit"}),variable:c.jsx(it,{fontSize:"inherit"}),constant:c.jsx(st,{fontSize:"inherit"}),field:c.jsx(we,{fontSize:"inherit"}),property:c.jsx(we,{fontSize:"inherit"}),component:c.jsx(nt,{fontSize:"inherit"}),struct:c.jsx(tt,{fontSize:"inherit"}),module:c.jsx(et,{fontSize:"inherit"}),namespace:c.jsx(Qe,{fontSize:"inherit"}),htmlTag:c.jsx(Ye,{fontSize:"inherit"}),cssSelector:c.jsx(Ge,{fontSize:"inherit"})},Se=[{kind:"class",label:"클래스"},{kind:"function",label:"함수"},{kind:"interface",label:"인터페이스"},{kind:"struct",label:"구조체/레코드"},{kind:"enum",label:"열거형"},{kind:"method",label:"메서드"},{kind:"variable",label:"변수"},{kind:"constant",label:"상수"},{kind:"field",label:"필드"},{kind:"property",label:"프로퍼티"},{kind:"component",label:"UI 컴포넌트"},{kind:"module",label:"모듈/패키지"},{kind:"namespace",label:"네임스페이스"},{kind:"htmlTag",label:"HTML 태그"},{kind:"cssSelector",label:"CSS 선택자"},{kind:"unknown",label:"기타"}],je=t=>Xt[t]??c.jsx(Je,{fontSize:"inherit"}),Jt={javascript:".js",typescript:".ts",tsx:".tsx",java:".java",kotlin:".kt",python:".py",go:".go",rust:".rs",c:".c",cpp:".cpp,.cc,.cxx,.hpp,.hh,.hxx",csharp:".cs",php:".php",ruby:".rb",scala:".scala",sql:".sql",html:".html,.htm",css:".css",json:".json",yaml:".yml,.yaml",txt:".txt"},ze=(t,l)=>{t.forEach(s=>{l.add(s.id),s.children.length&&ze(s.children,l)})},Gt=(t,l)=>{const s=[],e=(r,a)=>{r.forEach(n=>{s.push({node:n,depth:a}),n.children.length&&l.has(n.id)&&e(n.children,a+1)})};return e(t,0),s},sn=()=>{const{languageId:t,changeLanguage:l,source:s,setSource:e,outline:r,outlineCount:a,diagnostics:n,engine:i,loading:u,error:d,handleAnalyze:p,handleFileSelect:h,handleSampleLoad:g,fileInputRef:_,languageOptions:w}=Vt(),z=Ie(),A=z.palette.mode==="dark"?"outline-dark-transparent":"outline-light-transparent",P=Pe(z.breakpoints.up("md")),O=j.useMemo(()=>a?`${a}개의 최상위 심볼`:"결과 없음",[a]),Y=j.useRef(null),Z=j.useRef(!1),[V,f]=j.useState(.55),M=V,b=1-V,[C,k]=j.useState(null),x=Jt[t]??".js,.ts,.tsx,.java,.kt,.py,.go,.rs,.c,.cpp,.cc,.cxx,.hpp,.hh,.hxx,.cs,.php,.rb,.scala,.sql,.html,.htm,.css,.json,.yml,.yaml,.txt",[v,I]=j.useState(new Set),[D,E]=j.useState(null),T=j.useRef(null),F=j.useRef(null),[W,q]=j.useState({width:0,height:0}),X=j.useMemo(()=>Gt(r,v),[r,v]),J=j.useCallback(o=>{I(m=>{const y=new Set(m);return y.has(o)?y.delete(o):y.add(o),y})},[]),se=j.useCallback(o=>{E(o.id);const m=o.line+1,y=T.current;y&&(y.revealLineInCenter(m),y.setSelection({startLineNumber:m,startColumn:1,endLineNumber:m,endColumn:1}),y.focus())},[]),B=j.useCallback(({index:o,style:m})=>{const{node:y,depth:L}=X[o],Q=y.children.length>0,ee=v.has(y.id),ie=y.id===D;return c.jsxs(R,{style:m,sx:{display:"flex",alignItems:"center",pl:1+L*1.5,pr:1,gap:1,cursor:"pointer",bgcolor:ie?"action.selected":void 0},onClick:()=>se(y),children:[Q?c.jsx(ae,{size:"small",onClick:K=>{K.stopPropagation(),J(y.id)},children:ee?c.jsx(Le,{fontSize:"small"}):c.jsx(Me,{fontSize:"small"})}):c.jsx(R,{sx:{width:32}}),c.jsx(R,{sx:{display:"flex",color:"text.secondary"},children:je(y.kind)}),c.jsx(G,{variant:"body2",fontWeight:600,noWrap:!0,component:"span",children:y.label}),y.annotation&&c.jsx(G,{component:"span",variant:"caption",color:"text.secondary",noWrap:!0,sx:{ml:.5},children:y.annotation}),c.jsxs(G,{variant:"caption",color:"text.secondary",children:["L",y.line+1]})]})},[v,se,J,D,X]),U=j.useCallback(o=>Math.min(Math.max(o,.2),.8),[]),N=j.useCallback(o=>{if(!Y.current)return;const m=Y.current.getBoundingClientRect();if(m.width<=0)return;const y=(o-m.left)/m.width;f(U(y))},[U]),S=j.useCallback(()=>{Z.current=!1,document.body.style.cursor="",document.body.style.userSelect=""},[]),$=j.useCallback(o=>{if(P)if(Z.current=!0,document.body.style.cursor="col-resize",document.body.style.userSelect="none","touches"in o){const m=o.touches[0];m&&N(m.clientX)}else N(o.clientX)},[P,N]);return j.useEffect(()=>{const o=L=>{Z.current&&(L.preventDefault(),N(L.clientX))},m=L=>{if(!Z.current)return;const Q=L.touches[0];Q&&(L.preventDefault(),N(Q.clientX))},y=()=>S();return window.addEventListener("mousemove",o),window.addEventListener("mouseup",y),window.addEventListener("touchmove",m,{passive:!1}),window.addEventListener("touchend",y),window.addEventListener("touchcancel",y),()=>{window.removeEventListener("mousemove",o),window.removeEventListener("mouseup",y),window.removeEventListener("touchmove",m),window.removeEventListener("touchend",y),window.removeEventListener("touchcancel",y)}},[S,N]),j.useEffect(()=>{P?f(o=>U(o||.55)):(Z.current=!1,document.body.style.cursor="",document.body.style.userSelect="",f(1))},[U,P]),j.useEffect(()=>{const o=new Set;ze(r,o),I(o),E(null)},[r]),j.useLayoutEffect(()=>{const o=F.current;if(!o)return;const m=new ResizeObserver(y=>{const L=y[0];L&&q({width:L.contentRect.width,height:L.contentRect.height})});return m.observe(o),()=>m.disconnect()},[]),c.jsxs(Ze,{sx:{p:1.25,display:"flex",flexDirection:"column",gap:1.25,flex:1,minHeight:785,height:"100%",width:1,maxWidth:"100%",overflowX:"hidden"},children:[c.jsxs(te,{direction:"row",spacing:1.25,alignItems:"center",children:[c.jsxs(Ee,{size:"small",sx:{minWidth:220},children:[c.jsx(Re,{id:"code-outline-language",children:"언어"}),c.jsx(De,{labelId:"code-outline-language",value:t,label:"언어",onChange:o=>l(o.target.value),children:w.map(o=>c.jsx(Oe,{value:o.id,children:o.label},o.id))})]}),c.jsxs(le,{variant:"outlined",startIcon:c.jsx(Te,{}),component:"label",sx:{minWidth:200},children:["파일 업로드",c.jsx("input",{hidden:!0,type:"file",accept:x,ref:_,onChange:o=>{const m=o.target.files?.[0]??null;h(m)}})]}),c.jsx(le,{variant:"outlined",color:"secondary",startIcon:c.jsx(We,{}),onClick:g,sx:{minWidth:200},children:"샘플 코드 불러오기"}),c.jsx(R,{sx:{flex:1}}),c.jsx(te,{direction:"row",spacing:1,alignItems:"center",children:c.jsx(le,{variant:"contained",startIcon:u?c.jsx(Ne,{color:"inherit",size:16}):c.jsx(qe,{}),onClick:()=>p(),disabled:u,children:"Outline 생성"})})]}),c.jsxs(R,{ref:Y,sx:{flex:1,minHeight:0,width:1,display:"grid",flexDirection:"row",gridTemplateColumns:`minmax(0, ${M}fr) 6px minmax(0, ${b}fr)`,gap:1.25,columnGap:1.25,touchAction:"none",contain:"layout paint size",alignItems:"stretch"},children:[c.jsxs(te,{sx:{border:"1px solid",borderColor:"divider",borderRadius:.75,overflow:"hidden",minHeight:0},children:[c.jsxs(R,{sx:{px:1.25,py:1.25,borderBottom:"1px solid",borderColor:"divider",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[c.jsx(G,{variant:"subtitle2",children:"편집기"}),c.jsxs(G,{variant:"caption",color:"text.secondary",children:[s.length.toLocaleString()," chars"]})]}),c.jsx(R,{sx:{flex:1,minHeight:240},children:c.jsx(ut,{height:"100%",defaultLanguage:"typescript",language:t==="java"?"java":"typescript",theme:A,value:s,onChange:o=>e(o??""),onMount:(o,m)=>{T.current=o,m&&(m.editor.defineTheme(A,{base:z.palette.mode==="dark"?"vs-dark":"vs",inherit:!0,rules:[],colors:{"editor.background":"#00000000","editorLineNumber.background":"#00000000","editor.lineHighlightBackground":"#00000000"}}),m.editor.setTheme(A))},options:{wordWrap:"on",minimap:{enabled:!1},automaticLayout:!0,fontSize:13}})})]}),c.jsx(R,{sx:{display:"flex",width:6,justifySelf:"stretch",cursor:P?"col-resize":"default",bgcolor:"divider",borderRadius:.75,alignItems:"center",justifyContent:"center",userSelect:"none"},role:"separator","aria-orientation":"vertical",onMouseDown:$,onTouchStart:$,children:c.jsxs(R,{sx:{display:"flex",flexDirection:"column",gap:.25},children:[c.jsx(R,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}}),c.jsx(R,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}}),c.jsx(R,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}})]})}),c.jsxs(te,{sx:{border:"1px solid",borderColor:"divider",borderRadius:.75,minHeight:0,overflow:"hidden"},children:[c.jsxs(R,{sx:{px:1.25,py:1.25,borderBottom:"1px solid",borderColor:"divider",display:"flex",alignItems:"center",justifyContent:"space-between"},children:[c.jsxs(te,{direction:"row",spacing:1,alignItems:"center",children:[c.jsx(G,{variant:"subtitle2",children:"Outline"}),c.jsx(me,{title:"아이콘 설명",children:c.jsx(ae,{size:"small",onClick:()=>k({title:"Outline 아이콘 안내",items:Se.map(o=>`${o.label} (${o.kind})`)}),children:c.jsx(ge,{fontSize:"small"})})}),i&&c.jsx(be,{size:"small",color:i==="tree-sitter"?"primary":"warning",label:i==="tree-sitter"?"Tree-sitter 성공":"Fallback (간단한 파서)"}),(d||n.length)&&c.jsx(me,{title:d?"에러 상세 보기":i==="fallback"?"Fallback 사용 이유":"분석 정보",children:c.jsx(ae,{size:"small",color:d?"error":i==="fallback"?"warning":"info",onClick:()=>k({title:d?"에러":i==="fallback"?"Fallback 사용 안내":"분석 정보",items:d?[d]:n.length?n:["Tree-sitter 실행에 실패하여 간단한 파서 결과만 표시합니다."]}),children:d?c.jsx(Be,{fontSize:"small"}):i==="fallback"?c.jsx(Ue,{fontSize:"small"}):c.jsx(ge,{fontSize:"small"})})})]}),c.jsx(be,{size:"small",label:O,variant:"outlined"})]}),c.jsx(R,{sx:{flex:1,px:0,py:.5},ref:F,children:r.length&&W.height>0&&W.width>0?c.jsx(Ce,{height:W.height,width:W.width,itemCount:X.length,itemSize:36,overscanCount:8,children:B}):c.jsx(te,{alignItems:"center",justifyContent:"center",sx:{height:"100%"},spacing:1,children:c.jsx(G,{variant:"body2",color:"text.secondary",children:"분석된 구조가 없습니다. 샘플을 불러오거나 우측 버튼으로 Outline을 생성하세요."})})})]})]}),c.jsxs(Fe,{open:!!C,onClose:()=>k(null),maxWidth:"sm",fullWidth:!0,children:[c.jsxs(Ke,{children:[C?.title,c.jsx(ae,{onClick:()=>k(null),sx:{position:"absolute",right:8,top:1.25},children:c.jsx(He,{})})]}),c.jsx(Ve,{dividers:!0,children:C?.title==="Outline 아이콘 안내"?c.jsx(R,{sx:{px:1.25,py:.5,borderColor:"divider",display:"flex",flexWrap:"wrap",gap:1.25},children:Se.map(o=>c.jsxs(te,{direction:"row",spacing:.5,alignItems:"center",sx:{minWidth:120},children:[c.jsx(R,{sx:{color:"text.secondary",display:"flex"},children:je(o.kind)}),c.jsx(G,{variant:"caption",color:"text.secondary",children:o.label})]},o.kind))}):c.jsx(te,{spacing:1,children:C?.items.map((o,m)=>c.jsx(G,{variant:"body2",children:o},m))})}),c.jsx(Xe,{children:c.jsx(le,{onClick:()=>k(null),children:"닫기"})})]})]})};export{sn as default};
