import{r as a,j as s}from"./vendor-DKqYS5EO.js";import{u as te,P as ne,B as A,H as oe,J as re,S as V,T as B,a as X,ab as se,af as ae,l as ie,m as le,n as ce,ae as de}from"./mui-Lc6_wn4i.js";import{M as Z}from"./monaco-editor-DQsLY_OW.js";import"./excel-CUMakpxJ.js";import"./tree-sitter-B45I1zdL.js";const W=40,Q="calc(100vh - 285px)",ue=({controller:u})=>{const{tabIndex:j,languageTabs:y,convertedCode:b,jsonRaw:g,loading:l,downloadState:c,handleLoadJson:f,handleFormatJson:x,handleDownloadCurrent:v,handleLangTabChange:S,handleJsonTextChange:C}=u,m=te(),e=a.useId(),h=a.useRef(null),o=a.useRef(null),p=a.useRef(!1),[t,r]=a.useState(.5),d=a.useRef(null),$=a.useRef(null),J=l||c.open,O=y[j]??y[0],I=m.palette.mode==="dark"?"vs-dark":"vs-light",H=t,_=Math.max(1-t,.05),n=a.useCallback(()=>{requestAnimationFrame(()=>{d.current?.layout(),$.current?.layout(),requestAnimationFrame(()=>{d.current?.layout(),$.current?.layout()})})},[]),L=i=>{const w=i.target.files?.[0]??null;f(w),h.current&&(h.current.value="")},N=a.useCallback((i,w,T)=>Math.min(Math.max(i,w),T),[]),R=a.useCallback(i=>{if(!o.current)return;const w=o.current.getBoundingClientRect();if(w.width<=0)return;const T=N((i-w.left)/w.width,.2,.8);r(T)},[N]),E=a.useCallback(()=>{p.current&&(p.current=!1,document.body.style.cursor="",document.body.style.userSelect="",n())},[n]);a.useEffect(()=>{const i=k=>{p.current&&(k.preventDefault(),R(k.clientX),n())},w=k=>{if(!p.current)return;const P=k.touches[0];P&&(R(P.clientX),n())},T=()=>E(),M=()=>n();return window.addEventListener("mousemove",i),window.addEventListener("mouseup",T),window.addEventListener("touchmove",w,{passive:!1}),window.addEventListener("touchend",T),window.addEventListener("touchcancel",T),window.addEventListener("resize",M),()=>{window.removeEventListener("mousemove",i),window.removeEventListener("mouseup",T),window.removeEventListener("touchmove",w),window.removeEventListener("touchend",T),window.removeEventListener("touchcancel",T),window.removeEventListener("resize",M)}},[n,E,R]);const z=a.useCallback(i=>{if(i.preventDefault(),p.current=!0,document.body.style.cursor="col-resize",document.body.style.userSelect="none","touches"in i){const w=i.touches[0];w&&R(w.clientX)}else R(i.clientX)},[R]);a.useEffect(()=>{if(!o.current)return;const i=new ResizeObserver(()=>n());return i.observe(o.current),()=>i.disconnect()},[n]),a.useEffect(()=>{n()},[t,j,I,n]);const D=a.useCallback(i=>{d.current=i,i.setValue(g||""),requestAnimationFrame(()=>{i.layout(),requestAnimationFrame(()=>i.layout())})},[g]),U=a.useCallback(i=>{$.current=i,i.setValue(b||""),requestAnimationFrame(()=>{i.layout(),requestAnimationFrame(()=>i.layout())})},[b]);return a.useEffect(()=>{d.current&&d.current.getValue()!==g&&d.current.setValue(g||""),n()},[g,n]),a.useEffect(()=>{$.current&&$.current.getValue()!==b&&$.current.setValue(b||""),n()},[b,n]),s.jsxs(ne,{sx:{p:1.25,display:"flex",flexDirection:"column",flex:1,minHeight:785,height:"100%",width:1,maxWidth:"100%",overflowX:"hidden"},children:[s.jsx(A,{display:"flex",justifyContent:"flex-end",sx:{width:1,maxWidth:"100%"},children:s.jsx(oe,{sx:{pl:1.25,pr:1.25,minHeight:28},value:j,onChange:(i,w)=>{S(w)},children:y.map(i=>s.jsx(re,{label:i.label},i.id))})}),s.jsxs(A,{ref:o,sx:{display:"grid",gridTemplateColumns:`minmax(0, ${H}fr) 6px minmax(0, ${_}fr)`,columnGap:1,width:1,maxWidth:"100%",minWidth:0,overflowX:"hidden",alignItems:"stretch",touchAction:"none"},children:[s.jsxs(A,{sx:{p:1.25,pt:.5,border:"1px solid",borderColor:"divider",borderRadius:1,bgcolor:"background.paper",display:"flex",flexDirection:"column",gap:.5,minWidth:0,overflow:"hidden",minHeight:680},children:[s.jsxs(V,{direction:"row",spacing:1,alignItems:"center",justifyContent:"space-between",sx:{height:W,minHeight:W},children:[s.jsx(B,{variant:"subtitle2",children:"JSON"}),s.jsxs(V,{direction:"row",spacing:1,alignItems:"center",children:[s.jsx(X,{variant:"outlined",size:"small",onClick:x,disabled:J||!g.trim(),sx:{minWidth:110},children:"JSON 포맷"}),s.jsx("input",{ref:h,id:e,type:"file",accept:".json",hidden:!0,onChange:L}),s.jsx("label",{htmlFor:e,children:s.jsx(X,{className:"ctrl",component:"span",variant:"contained",startIcon:s.jsx(se,{}),size:"small",disabled:J,sx:{minWidth:120},children:"JSON 업로드"})})]})]}),s.jsxs(A,{sx:{height:Q,minHeight:640,minWidth:0,border:"1px solid",borderColor:"divider",borderRadius:1,overflow:"hidden",bgcolor:"background.paper",position:"relative"},children:[s.jsx(Z,{height:"100%",language:"json",defaultLanguage:"json",theme:I,value:g,onMount:D,onChange:i=>{typeof i=="string"&&C(i)},options:{wordWrap:"on",minimap:{enabled:!1},automaticLayout:!1,scrollBeyondLastLine:!1,fontSize:12,tabSize:2}}),!g.trim()&&s.jsx(A,{sx:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"none",px:1.25,textAlign:"center"},children:s.jsx(B,{variant:"body2",color:"text.secondary",children:"JSON 파일을 업로드하거나 이 영역에 직접 JSON을 입력해 주세요."})})]})]}),s.jsx(A,{sx:{width:6,justifySelf:"stretch",cursor:"col-resize",bgcolor:"divider","&:hover":{bgcolor:"action.hover"},borderRadius:1,display:"flex",alignItems:"center",justifyContent:"center",userSelect:"none"},onMouseDown:z,onTouchStart:z,children:s.jsxs(A,{sx:{display:"flex",flexDirection:"column",gap:.25},children:[s.jsx(A,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}}),s.jsx(A,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}}),s.jsx(A,{sx:{width:2,height:2,bgcolor:"text.secondary",borderRadius:"50%"}})]})}),s.jsxs(A,{sx:{p:1.25,pt:.5,border:"1px solid",borderColor:"divider",borderRadius:1,bgcolor:"background.paper",display:"flex",flexDirection:"column",gap:.5,minWidth:0,overflow:"hidden",minHeight:680},children:[s.jsxs(V,{direction:"row",spacing:1,alignItems:"center",justifyContent:"space-between",sx:{height:W,minHeight:W},children:[s.jsx(B,{variant:"subtitle2",children:O?.label}),s.jsx(X,{className:"ctrl",onClick:v,variant:"contained",color:"primary",size:"small",startIcon:s.jsx(ae,{}),disabled:J,sx:{minWidth:160},children:"다운로드"})]}),s.jsxs(A,{sx:{height:Q,minHeight:640,minWidth:0,border:"1px solid",borderColor:"divider",borderRadius:1,overflow:"hidden",position:"relative",bgcolor:"background.paper"},children:[s.jsx(Z,{height:"100%",language:O?.language??"java",defaultLanguage:O?.language??"java",theme:I,value:b,onMount:U,options:{readOnly:!0,wordWrap:"on",minimap:{enabled:!1},automaticLayout:!1,scrollBeyondLastLine:!1,fontSize:12,tabSize:2}}),!b.trim()&&s.jsx(A,{sx:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"none",px:1.25,textAlign:"center"},children:s.jsxs(B,{variant:"body2",color:"text.secondary",children:["변환 결과(",O?.label,")가 이 영역에 표시됩니다."]})})]})]})]}),s.jsxs(ie,{open:c.open,fullWidth:!0,maxWidth:"xs",children:[s.jsx(le,{children:c.label||"다운로드 중…"}),s.jsx(ce,{children:s.jsxs(A,{sx:{py:1.25},children:[s.jsx(de,{variant:"determinate",value:c.progress}),s.jsxs(B,{variant:"caption",sx:{display:"block",mt:1,textAlign:"right"},children:[c.progress,"%"]})]})})]})]})},F=[{id:"java",label:"Java",language:"java"},{id:"dart",label:"Dart",language:"dart"},{id:"typescript",label:"TypeScript",language:"typescript"}],fe={java:"java",dart:"dart",typescript:"ts"},Y=`{
  "key": "string",
  "num": 1
